...
Заходь, вливайся та будь як удома! 😎,правила чату в закрепі"""

        elif gender == 'Хлопець':
            greeting = f"""Йо, <b>{name}</b>, вітаємо в чаті! 🤝
Сідай до нашого вогнища, скидай зброю.
Вливайся в колектив, спілкуйся та будь як удома! 🍕,правила чату в закрепі"""

        else:
            greeting = f"""Вітаємо в нашій групі, <b>{name}</b>! 🤍
Напиши пару слів про себе або кидай улюблений мем, щоб одразу залетіти в тему! ✨,правила чату в закрепі"""
